...
describe('Service Tests', () => {
  describe('Fruit Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(FruitService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Fruit(0, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Fruit', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            type: 'BBBBBB',
